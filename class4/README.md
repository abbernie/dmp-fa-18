...
Use the [class2](https://github.com/abbernie/dmp-fa-17/tree/master/class2) reference as a guide for mouse and key interaction. Also use McCarthy book (p. 203-205) and [p5 reference](http://p5js.org/reference/#/libraries/p5.sound) online!
